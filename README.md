...
```yaml
profile:
  role: Aspiring Cybersecurity Engineer — Purple Team
  mindset: Security-First | Curiosity-Driven | Continuous Learner
  approach:
    offensive: "Break responsibly to understand how systems truly work"
    defensive: "Build resilient defenses grounded in real attack knowledge"
    philosophy: "Seeing both sides of the fence is what makes security meaningful"
  foundation:
    - Software development fundamentals applied to security thinking
    - Networking basics and protocol understanding
    - Linux environments as daily learning ground
    - Python scripting for automation and analysis
  currently:
    - Building a personal home lab for hands-on practice
    - Studying for CompTIA Security+
    - Exploring TryHackMe learning paths
  open_to:
    - Junior SOC Analyst roles
    - Security internships and apprenticeships
...
|--------|--------|---------|
| **Offensive Security** | `Exploring` | Understanding enumeration basics, OWASP Top 10, CTF fundamentals |
| **Defensive Security** | `Learning` | Log analysis concepts, incident response fundamentals, basic hardening |
| **Cloud Security** | `Curious` | AWS shared responsibility model, IAM basics, storage security concepts |
| **Network Security** | `Exploring` | TCP/IP foundations, traffic analysis with Wireshark, firewall basics |
| **Scripting for Security** | `Learning` | Python scripts for task automation, basic file parsing and reporting |
| **Purple Team Thinking** | `Interested` | Understanding how offensive insight strengthens defensive strategy |
...
current_focus:
  learning:
    - Offensive foundations: enumeration, basic exploitation concepts, OWASP Top 10
    - Defensive strategies: log analysis, incident response fundamentals, hardening
    - Cloud security: AWS IAM, S3 security, shared responsibility model
  building:
    - Personal home lab with realistic attack/defense scenarios
    - Security study documentation and CTF beginner write-ups
    - Python utility scripts for log parsing and automation
  exploring:
    - Purple Team concepts: how offensive insight improves defensive posture
    - Basic network traffic analysis with Wireshark
    - Container security fundamentals with Docker
  open_to:
    - Junior SOC Analyst positions
    - Security internships (offensive or defensive)
    - Mentorship from experienced security professionals
    - Collaborative study groups and knowledge sharing
    - First professional opportunities under structured guidance
```
...
<p align="center">
  <a href="mailto:bordeianaudelin@gmail.com">
    <img src="https://img.shields.io/badge/GMAIL-0d0d0d?style=for-the-badge&logo=gmail&logoColor=00FF41"/>
  </a>
  <a href="https://www.linkedin.com/in/adelin-florian-bordeianu/">
